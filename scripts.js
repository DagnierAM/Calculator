class Calculator {
    ...
    getDisplayNumber(number) {
        ...
        let intDisplay;
        (isNaN(intDigits)) ? intDisplay = '' : intDisplay = intDigits.toLocaleString('en', { maximumFractionDigits: 0 });
    ...
    updateDisplay() {
        this.currentOpTxtElement.textContent = this.getDisplayNumber(this.currentOperand);
        if (this.operation != null) {
            this.previousOpTxtElement.textContent =
